...
var $author$project$TwelveDays$beginning = function (numberOfDay) {
	return 'On the ' + (numberOfDay + ' day of Christmas my true love gave to me: ');
};
var $author$project$TwelveDays$numberTense = function (numbski) {
	switch (numbski) {
		case 1:
		...
		case 4:
			return _Utils_Tuple2('fourth', 'four Calling Birds');
		case 5:
			return _Utils_Tuple2('fifth', 'five Gold Rings');
		case 6:
			return _Utils_Tuple2('sixth', 'six Geese-a-Laying');
		case 7:
			return _Utils_Tuple2('seventh', 'seven Swans-a-Swimming');
		case 8:
			return _Utils_Tuple2('eighth', 'eight Maids-a-Milking');
		case 9:
			return _Utils_Tuple2('ninth', 'nine Ladies Dancing');
		case 10:
			return _Utils_Tuple2('tenth', 'ten Lords-a-Leaping');
		case 11:
			return _Utils_Tuple2('eleventh', 'eleven Pipers Piping');
		case 12:
			return _Utils_Tuple2('twelfth', 'twelve Drummers Drumming');
		default:
			return _Utils_Tuple2('AHHHH', 'AHHHH');
	}
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					A2($author$project$TwelveDays$recite, 1, 1));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					...
					A2($author$project$TwelveDays$recite, 2, 2));
			}),
			...
			A2(
				...
				function (_v2) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 3, 3));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v3) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 4, 4));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v4) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 5, 5));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v5) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 6, 6));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v6) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 7, 7));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v7) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 8, 8));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v8) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 9, 9));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v9) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 10, 10));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v10) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 11, 11));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v11) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 12, 12));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v12) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 1, 3));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				...
				function (_v13) {
					return A2(
						...
						A2($author$project$TwelveDays$recite, 4, 6));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main3517522084$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/Users/daniel/Exercism/elm/twelve-days/tests/Tests.elm']),
		processes: 4,
