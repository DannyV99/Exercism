...
var $author$project$Leap$littleHelper = F2(
	function (daNumber, x) {
		return $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				$elm$core$Basics$remainderBy(daNumber),
				_List_fromArray(
					[x])));
	});
var $author$project$Leap$isLeapYear = function (year) {
	return ((!A2($author$project$Leap$littleHelper, 100, year)) && (A2($author$project$Leap$littleHelper, 400, year) > 0)) ? false : ((!A2($author$project$Leap$littleHelper, 4, year)) ? true : false);
};
...
var $author$project$Test$Generated$Main3960589041$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/daniel/Exercism/elm/leap/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 401616552289691
	},
...
_Platform_export({'Test':{'Generated':{'Main3960589041':{'init':$author$project$Test$Generated$Main3960589041$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-46504.sock";
