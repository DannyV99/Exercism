	...
	return $elm$core$String$toUpper(
		A2(
			...
			A2(
				$elm$core$List$map,
				function (z) {
					return A2($elm$core$String$left, 1, z);
				},
				$elm$core$String$words(
					A2(
						$elm$core$String$map,
						function (c) {
							return (!$elm$core$Char$isAlpha(c)) ? _Utils_chr(' ') : c;
						},
						phrase)))));
};
...
var $author$project$Test$Generated$Main951193342$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/daniel/Exercism/elm/acronym/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 171092273019074
	},
...
_Platform_export({'Test':{'Generated':{'Main951193342':{'init':$author$project$Test$Generated$Main951193342$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-54901.sock";
