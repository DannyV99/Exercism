...
var $author$project$Pangram$theFinisher = function (gimmeTheList) {
	return A2($elm$core$List$member, false, gimmeTheList) ? false : true;
};
var $elm$core$String$toLower = _String_toLower;
var $author$project$Pangram$theSetup = function (message) {
	var letters = _List_fromArray(
...
var $author$project$Pangram$isPangram = function (sentence) {
	return $author$project$Pangram$theFinisher(
		$author$project$Pangram$theSetup(sentence));
};
...
var $author$project$Test$Generated$Main3820454605$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/daniel/Exercism/elm/pangram/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 395660671166424
	},
...
_Platform_export({'Test':{'Generated':{'Main3820454605':{'init':$author$project$Test$Generated$Main3820454605$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-52257.sock";
