...
var $author$project$Bob$Unknown = {$: 'Unknown'};
var $author$project$Bob$bobsResponse = function (x) {
	switch (x.$) {
		case 'AskQuestion':
			return 'Sure.';
		case 'YellAtHim':
...
var $author$project$Bob$AskQuestion = {$: 'AskQuestion'};
var $author$project$Bob$NotSayNothing = {$: 'NotSayNothing'};
var $author$project$Bob$YellAQuestion = {$: 'YellAQuestion'};
var $author$project$Bob$YellAtHim = {$: 'YellAtHim'};
...
var $author$project$Bob$questionCheck = function (str) {
	return A2($elm$core$String$right, 1, str) === '?';
};
var $author$project$Bob$silenceCheck = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$length,
	$elm$core$Basics$eq(0));
var $elm$core$String$any = _String_any;
var $author$project$Bob$isSymbolOrUpper = function (_char) {
	return $elm$core$Char$isUpper(_char) || (!$elm$core$Char$isLower(_char));
};
var $author$project$Bob$yellCheck = function (str) {
	return A2($elm$core$String$all, $author$project$Bob$isSymbolOrUpper, str) && A2($elm$core$String$any, $elm$core$Char$isUpper, str);
};
var $author$project$Bob$yellQuestionCheck = function (str) {
	return $author$project$Bob$yellCheck(str) && $author$project$Bob$questionCheck(str);
};
var $author$project$Bob$checkAllInteractions = function (x) {
	var mapper = function (_v0) {
		var f = _v0.a;
		var ifTrue = _v0.b;
		return f(x) ? ifTrue : $author$project$Bob$Unknown;
	};
	return A2(
		$elm$core$List$map,
		mapper,
		_List_fromArray(
			[
				_Utils_Tuple2($author$project$Bob$questionCheck, $author$project$Bob$AskQuestion),
				_Utils_Tuple2($author$project$Bob$yellCheck, $author$project$Bob$YellAtHim),
				_Utils_Tuple2($author$project$Bob$yellQuestionCheck, $author$project$Bob$YellAQuestion),
				_Utils_Tuple2($author$project$Bob$silenceCheck, $author$project$Bob$NotSayNothing)
			]));
};
var $author$project$Bob$foldingFunc = F2(
	function (prev, curr) {
		return _Utils_eq(curr, $author$project$Bob$Unknown) ? prev : curr;
	});
var $author$project$Bob$hey = A2(
	$elm$core$Basics$composeR,
	$elm$core$String$trim,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Bob$checkAllInteractions,
		A2(
			$elm$core$Basics$composeR,
			A2($elm$core$List$foldr, $author$project$Bob$foldingFunc, $author$project$Bob$Unknown),
			$author$project$Bob$bobsResponse)));
		...
		[
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'Whatever.',
					$author$project$Bob$hey('Hi there!'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'Whatever.',
					$author$project$Bob$hey('It\'s OK if you don\'t want to go work for NASA.'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'forceful questions',
			function (_v8) {
				return A2(
					...
					$author$project$Bob$hey('WHAT\'S GOING ON?'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'shouting numbers',
			...
			function (_v13) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'Whoa, chill out!',
					$author$project$Bob$hey('I HATE THE DENTIST'));
			}),
			A2(
			$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main3748652220$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['/Users/daniel/Exercism/elm/bob/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 394933530755639
	},
...
_Platform_export({'Test':{'Generated':{'Main3748652220':{'init':$author$project$Test$Generated$Main3748652220$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-2203.sock";
